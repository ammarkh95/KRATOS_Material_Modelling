...
#if !defined (KRATOS_TRANSVERSE_ISOTROPIC_3D_H_INCLUDED)
#define  KRATOS_TRANSVERSE_ISOTROPIC_3D_H_INCLUDED
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ElasticTransverseIsotropic3D
...
public:
    ...
    /// Counted pointer of ElasticTransverseIsotropic3D
    KRATOS_CLASS_POINTER_DEFINITION( ElasticTransverseIsotropic3D );
     ...
     * Copy constructor.
     */
    ElasticTransverseIsotropic3D (const ElasticTransverseIsotropic3D& rOther);

    /**
     * @brief Destructor.
     */
    ~ElasticTransverseIsotropic3D() override;
...
}; // Class ElasticTransverseIsotropic3D
}  // namespace Kratos.
