...
// Project includes
#include "custom_constitutive/MaxStress_orthotropic_instant_damage_3d.h"
...
MaxStressOrthotropicInstantDamage::MaxStressOrthotropicInstantDamage()
    : ConstitutiveLaw()
{
}
...
MaxStressOrthotropicInstantDamage::MaxStressOrthotropicInstantDamage(const MaxStressOrthotropicInstantDamage& rOther)
...
ConstitutiveLaw::Pointer MaxStressOrthotropicInstantDamage::Clone() const
{
    return Kratos::make_shared<MaxStressOrthotropicInstantDamage>(*this);
}
...
void  MaxStressOrthotropicInstantDamage::CalculateMaterialResponsePK2(ConstitutiveLaw::Parameters& rValues)
{
    KRATOS_TRY;
...
void MaxStressOrthotropicInstantDamage::CalculateMaterialResponsePK1 (ConstitutiveLaw::Parameters& rValues)
{
...
void MaxStressOrthotropicInstantDamage::CalculateMaterialResponseKirchhoff (ConstitutiveLaw::Parameters& rValues)
{
    CalculateMaterialResponsePK2(rValues);
}
...
void MaxStressOrthotropicInstantDamage::CalculateMaterialResponseCauchy (ConstitutiveLaw::Parameters& rValues)
{
    CalculateMaterialResponsePK2(rValues);
}
...
void MaxStressOrthotropicInstantDamage::InitializeMaterialResponsePK1(ConstitutiveLaw::Parameters& rValues)
{
...
void MaxStressOrthotropicInstantDamage::InitializeMaterialResponsePK2(ConstitutiveLaw::Parameters& rValues)
{
    // Small deformation so we can call the Cauchy method
    InitializeMaterialResponseCauchy(rValues);
}
...
void MaxStressOrthotropicInstantDamage::InitializeMaterialResponseCauchy(ConstitutiveLaw::Parameters& rValues)
{
...
void MaxStressOrthotropicInstantDamage::InitializeMaterialResponseKirchhoff(ConstitutiveLaw::Parameters& rValues)
{
    // Small deformation so we can call the Cauchy method
    InitializeMaterialResponseCauchy(rValues);
}
...
void MaxStressOrthotropicInstantDamage::FinalizeMaterialResponsePK1(ConstitutiveLaw::Parameters& rValues)
{
    // Small deformation so we can call the Cauchy method
...
void MaxStressOrthotropicInstantDamage::FinalizeMaterialResponsePK2(ConstitutiveLaw::Parameters& rValues)
{
    // Small deformation so we can call the Cauchy method
    FinalizeMaterialResponseCauchy(rValues);
}
...
void MaxStressOrthotropicInstantDamage::FinalizeMaterialResponseCauchy(ConstitutiveLaw::Parameters& rValues)
{
    // TODO: Add if necessary
}
...
void MaxStressOrthotropicInstantDamage::FinalizeMaterialResponseKirchhoff(ConstitutiveLaw::Parameters& rValues)
{
    // Small deformation so we can call the Cauchy method
    FinalizeMaterialResponseCauchy(rValues);
}
...
void MaxStressOrthotropicInstantDamage::GetLawFeatures(Features& rFeatures)
{
    //Set the type of law
...
int MaxStressOrthotropicInstantDamage::Check(
...
void MaxStressOrthotropicInstantDamage::CheckClearElasticMatrix(Matrix& rConstitutiveMatrix)
{
...
void MaxStressOrthotropicInstantDamage::CalculateElasticMatrix(
...
void MaxStressOrthotropicInstantDamage::CalculatePK2Stress(
...
void MaxStressOrthotropicInstantDamage::CheckFailureMaxStress(const Vector& rStrainVector,
...
void MaxStressOrthotropicInstantDamage::CalculateSecantMatrix(
...
void MaxStressOrthotropicInstantDamage::CalculateCauchyGreenStrain(
    ConstitutiveLaw::Parameters& rValues,
