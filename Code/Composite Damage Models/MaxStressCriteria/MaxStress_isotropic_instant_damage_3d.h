...
#if !defined (KRATOS_MAXSTRESS_ISOTROPIC_INSTANT_DAMAGE_3D_H_INCLUDED)

#define KRATOS_MAXSTRESS_ISOTROPIC_INSTANT_DAMAGE_3D_H_INCLUDED
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) MaxStressIsotropicInstantDamage
...
public:
    ...
    /// Counted pointer of MaxStressIsotropicInstantDamage
    KRATOS_CLASS_POINTER_DEFINITION( MaxStressIsotropicInstantDamage );
     ...
     */
    MaxStressIsotropicInstantDamage();
     ...
     * Copy constructor.
     */
    MaxStressIsotropicInstantDamage (const MaxStressIsotropicInstantDamage& rOther);

    /**
     * @brief Destructor.
     */
    ~MaxStressIsotropicInstantDamage() override;
...
}; // Class MaxStressIsotropicInstantDamage
}  // namespace Kratos.
#endif // KRATOS_MAXSTRESS_ISOTROPIC_INSTANT_DAMAGE_3D_H_INCLUDED defined
