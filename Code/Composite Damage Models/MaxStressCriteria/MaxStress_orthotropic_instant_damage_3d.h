...
#if !defined (KRATOS_MAXSTRESS_ORTHOTROPIC_INSTANT_DAMAGE_3D_H_INCLUDED)
#define  KRATOS_MAXSTRESS_ORTHOTROPIC_INSTANT_DAMAGE_3D_H_INCLUDED
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) MaxStressOrthotropicInstantDamage
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( MaxStressOrthotropicInstantDamage );
     ...
     */
    MaxStressOrthotropicInstantDamage();
     ...
     * Copy constructor.
     */
    MaxStressOrthotropicInstantDamage (const MaxStressOrthotropicInstantDamage& rOther);

    /**
     * @brief Destructor.
     */
    ~MaxStressOrthotropicInstantDamage() override;
...
}; // Class MaxStressOrthotropicInstantDamage
}  // namespace Kratos.
#endif // KRATOS_MAXSTRESS_ORTHOTROPIC_INSTANT_DAMAGE_3D_H_INCLUDED  defined
