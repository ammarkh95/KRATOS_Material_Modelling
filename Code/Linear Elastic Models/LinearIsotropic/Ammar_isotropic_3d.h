...
#if !defined (KRATOS_AMMAR_ISOTROPIC_3D_H_INCLUDED)
#define  KRATOS_AMMAR_ISOTROPIC_3D_H_INCLUDED
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) AmmarIsotropic3D
...
public:
    ...
    /// Counted pointer of AmmarIsotropic3D
    KRATOS_CLASS_POINTER_DEFINITION( AmmarIsotropic3D );
     ...
     * Copy constructor.
     */
    AmmarIsotropic3D (const AmmarIsotropic3D& rOther);

    /**
     * @brief Destructor.
     */
    ~AmmarIsotropic3D() override;
